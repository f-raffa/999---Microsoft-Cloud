...
IF EXISTS (SELECT * FROM sys.credentials WHERE NAME = 'DefaultLakeStorageCredentials')
...
WITH (
    LOCATION = 'https://datalakexfqecgy.dfs.core.windows.net/files/synapse/workspaces/synapse-all-labs-ws/warehouse',
