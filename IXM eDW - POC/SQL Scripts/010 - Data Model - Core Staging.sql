...
IF EXISTS ( SELECT *
    ...
    DROP EXTERNAL TABLE aquarius_ldcustom_landing.users;
...
IF EXISTS ( SELECT *
    ...
    DROP EXTERNAL TABLE aquarius_refined_landing.brands;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.brands (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/brands/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'companies'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.companies;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.companies (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/companies/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'contracts'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.contracts;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.contracts (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_landing.db/contracts/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'countries'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.countries;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.countries (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/countries/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'parties'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.parties;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.parties (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/parties/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'ports'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.ports;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.ports (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/ports/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'traders'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.traders;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.traders (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/traders/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'users'
               AND TABLE_SCHEMA = 'aquarius_refined_landing' )
    DROP EXTERNAL TABLE aquarius_refined_landing.users;
...
CREATE EXTERNAL TABLE aquarius_refined_landing.users (
  ...
  WITH (
    LOCATION = 'aquarius_refined_landing.db/users/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
    ...
    DROP EXTERNAL TABLE aquarius_ldcustom_staging.users;
...
IF EXISTS ( SELECT *
    ...
    DROP EXTERNAL TABLE aquarius_refined_staging.brands;
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'companies'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.companies;
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'contracts'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.contracts;
...
CREATE EXTERNAL TABLE aquarius_refined_staging.contracts (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_staging.db/contracts/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'countries'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.countries;
...
CREATE EXTERNAL TABLE aquarius_refined_staging.countries (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_staging.db/countries/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'parties'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.parties;
...
CREATE EXTERNAL TABLE aquarius_refined_staging.parties (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_staging.db/parties/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'ports'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.ports;
...
CREATE EXTERNAL TABLE aquarius_refined_staging.ports (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_staging.db/ports/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'traders'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.traders;
...
CREATE EXTERNAL TABLE aquarius_refined_staging.traders (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_staging.db/traders/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);
...
IF EXISTS ( SELECT *
             ...
             WHERE TABLE_NAME = 'users'
               AND TABLE_SCHEMA = 'aquarius_refined_staging' )
    DROP EXTERNAL TABLE aquarius_refined_staging.users;
...
CREATE EXTERNAL TABLE aquarius_refined_staging.users (
  ...
  WITH (
    LOCATION = '005-staging/aquarius_refined_staging.db/users/',
    DATA_SOURCE = DefaultLakeDataSource,
    FILE_FORMAT = ParquetFileFormat
);