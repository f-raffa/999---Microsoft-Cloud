...
sqlcmd -S "$synapseWorkspace.sql.azuresynapse.net" -U $sqlUser -P $sqlPassword -d $sqlDatabaseName -I -i "004 - Workspace Setup.sql"


write-host "Creating clod components for Quotas Usage and Limits..."
./"005 - Quotas Usage and Limits Setup.ps1"
