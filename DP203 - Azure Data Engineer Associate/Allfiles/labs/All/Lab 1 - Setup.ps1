...
echo $suffix > "000 - DeploymentSuffix.txt"
...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName `
  -Name "synapse-workspace-infrastructure-and-initial-data-deployment" `
  -TemplateFile "Lab 1 - Setup.json" `
  -Mode Incremental `
...
sqlcmd -S "$synapseWorkspace.sql.azuresynapse.net" -U $sqlUser -P $sqlPassword -d $sqlDatabaseName -I -i "Lab 1 - Setup.sql"
